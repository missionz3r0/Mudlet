describe("Tests TableUtils.lua functions", function()
	...
	describe("Tests the functionality of table.matches", function()
		...
		it("should throw an error if the pattern passed is not a string", function()
			...
			assert.has_error(
				errfn,
				"table.matches: bad argument #2 type (pattern to check as string expected, got number)"
			)
			errfn = function()
			...
			assert.has_error(
				errfn,
				"table.matches: bad argument #3 type (pattern to check as string expected, got number)"
			)
		end)
	...
	describe("Tests the functionality of table.n_matches", function()
		...
		it("should throw an error if the pattern passed is not a string", function()
			...
			assert.has_error(
				errfn,
				"table.n_matches: bad argument #2 type (pattern to check as string expected, got number)"
			)
			errfn = function()
			...
			assert.has_error(
				errfn,
				"table.n_matches: bad argument #3 type (pattern to check as string expected, got number)"
			)
		end)
